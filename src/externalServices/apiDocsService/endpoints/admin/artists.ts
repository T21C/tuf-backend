...
const artistsEndpoints: EndpointDefinition[] = [
  {
    method: 'GET',
    path: '/v2/admin/artists',
    description: 'Get all artists with pagination, search, and filters (admin view with verification state)',
    category: 'ADMIN',
    requiresAuth: true,
    parameters: {
      query: {
  ...
  {
    method: 'GET',
    path: '/v2/admin/artists/:id',
    description: 'Get artist detail with aliases, links, evidences, and song credits',
    category: 'ADMIN',
    requiresAuth: true,
    parameters: {
      path: {
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/avatar',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/merge',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/split/check',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/split',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/aliases',
  ...
  {
    method: 'DELETE',
    path: '/v2/admin/artists/:id/aliases/:aliasId',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/links',
  ...
  {
    method: 'DELETE',
    path: '/v2/admin/artists/:id/links/:linkId',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/evidences',
  ...
  {
    method: 'POST',
    path: '/v2/admin/artists/:id/evidences/upload',
  ...
  {
    method: 'PUT',
    path: '/v2/admin/artists/:id/evidences/:evidenceId',
