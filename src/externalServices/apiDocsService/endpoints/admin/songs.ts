...
const songsEndpoints: EndpointDefinition[] = [
  {
    method: 'GET',
    path: '/v2/admin/songs',
    description: 'Get all songs with pagination, search, and filters (admin view with verification state)',
    category: 'ADMIN',
    requiresAuth: true,
    parameters: {
      query: {
        page: 'string (optional) - Page number (default: "1")',
        limit: 'string (optional) - Items per page (default: "100", max: 200)',
  ...
  {
    method: 'GET',
    path: '/v2/admin/songs/:id/levels/info',
  ...
  {
    method: 'GET',
    path: '/v2/admin/songs/:id',
    description: 'Get song detail with aliases, links, evidences, credits, and levels',
    category: 'ADMIN',
    requiresAuth: true,
    parameters: {
      path: {
    ...
    responses: {
      '200': 'Returns song object with aliases, links, evidences, credits, and levels',
      '404': 'Song not found',
  ...
  {
    method: 'POST',
    path: '/v2/admin/songs/:id/aliases',
  ...
  {
    method: 'DELETE',
    path: '/v2/admin/songs/:id/aliases/:aliasId',
  ...
  {
    method: 'DELETE',
    path: '/v2/admin/songs/:id/links/:linkId',
  ...
  {
    method: 'POST',
    path: '/v2/admin/songs/:id/evidences',
  ...
  {
    method: 'POST',
    path: '/v2/admin/songs/:id/evidences/upload',
  ...
  {
    method: 'PUT',
    path: '/v2/admin/songs/:id/evidences/:evidenceId',
  ...
  {
    method: 'POST',
    path: '/v2/admin/songs/:id/credits',
  ...
  {
    method: 'DELETE',
    path: '/v2/admin/songs/:id/credits/:creditId',
  ...
  {
    method: 'POST',
    path: '/v2/admin/songs/:id/levels/suffix',
